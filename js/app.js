...
const apikey = 'cfbea9bfcd87f90b5271f8e73970e168';
let pagenumber = 1;
...
function getapi() {
  ...
  //= =====================================================================================
  const api1 = `${baseUrl}discover/movie?api_key=${apikey}&with_keywords=207317&page=${pagenumber}`;
  ...
  fetch(api1)
    ...
    .then(data => {
      data.results.forEach(movie => {
        ...
        // laver div som et child element til det html element som har id'et posterSection
        ...
        posterDiv.addEventListener('click', function() {
          ...
          //= =====================================================================================
          //   fetch til trailer tager den movie der bliver klikket på og kobler den på api2,
          //   med getMovie variablen.
          //= =====================================================================================
          ...
          fetch(api2)
            ...
            .then(data2 => {
              ...
              // output
              const outputTrailer = `<div class="iframe-container">${iframe}</div> `;
          ...
          fetch(api3)
            ...
            .then(data3 => {
              ...
              // .map can extract by key name, fx .name gets all the actor names, .character gets the role name
              const getCastMemberNames = items.map(castMember => castMember.name);
              // slice will take the to first values that has the name key
